...
const EventServices = {
    ...
    deleteUserAudios: (data) => request.post('/event/delete-audios', data),
    listRecordType: () => request.get('/event/record-type'),
    updateRecordType: data => request.post('/event/record-type', data),
    updateAllowDownload: data => request.post('/event/allow-download', data),
}
